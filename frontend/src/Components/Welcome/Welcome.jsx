...
import shoppingImg from "../Assets/welcome-actions.svg"; // <-- use your own image path

const Welcome = () => {
  const navigate = useNavigate();
  const actions = [
    { icon: <FaPlusCircle color="#e53935" />, label: "Add a new item", path: "/add-item" },
    { icon: <FaSearch color="#1e88e5" />, label: "Browse listings", path: "/browse" },
    { icon: <FaUserEdit color="#43a047" />, label: "Manage account", path: "/account" },
